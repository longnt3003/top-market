...
namespace TopMarket.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public async Task<ActionResult> PostProfile(ApplicationUser req)
		{
			...
			if (rs.Succeeded) return RedirectToAction("Profile");
		...
		public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if ((user == null)
					|| !await UserManager.IsEmailConfirmedAsync(user.Id)) return View("ForgotPasswordConfirmation");
			}
